...
<CodeGroup>
```bash cURL
curl -X PATCH https://cronapi.dev/api/v1/jobs/b2c3d4e5-f6a7-8901-bcde-f12345678901 \
...
const response = await fetch(
  `https://cronapi.dev/api/v1/jobs/${jobId}`,
  {
    method: "PATCH",
    headers: {
...
response = requests.patch(
    f"https://cronapi.dev/api/v1/jobs/{job_id}",
