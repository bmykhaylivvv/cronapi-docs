...
<CodeGroup>
```bash cURL
curl https://cronapi.dev/api/v1/jobs/b2c3d4e5-f6a7-8901-bcde-f12345678901/runs \
  -H "Authorization: Bearer your_api_key_here"
```

```javascript Node.js
const response = await fetch(
  `https://cronapi.dev/api/v1/jobs/${jobId}/runs`,
...
response = requests.get(
    f"https://cronapi.dev/api/v1/jobs/{job_id}/runs",
    headers={"Authorization": "Bearer your_api_key_here"},
)
runs = response.json()
```
