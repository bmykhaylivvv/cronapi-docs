...
<CodeGroup>
```bash cURL
curl https://cronapi.dev/api/v1/crons/a1b2c3d4-e5f6-7890-abcd-ef1234567890/runs \
  -H "Authorization: Bearer your_api_key_here"
```

```javascript Node.js
const response = await fetch(
  `https://cronapi.dev/api/v1/crons/${cronId}/runs`,
...
response = requests.get(
    f"https://cronapi.dev/api/v1/crons/{cron_id}/runs",
    headers={"Authorization": "Bearer your_api_key_here"},
)
runs = response.json()
```
